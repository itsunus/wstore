...
function eightstore_lite_get_title($title){
	...
	if( $count > 1 ){
		$i=0;
		$e_title .= "<p class='first-three'>".$arr[$i++]." ".$arr[$i++]." ".$arr[$i++]."</p>";
...
function eightstore_lite_homepage_slider_config(){
	$display_slider = (get_theme_mod('display_slider'))?get_theme_mod('display_slider'):"1";
	if(get_theme_mod('display_pager')){
		$display_pager = (get_theme_mod('display_pager')=="0") ? "false" : "true";
	}else{
		$display_pager = "true";
	}
	if(get_theme_mod('display_controls')){
		$display_controls = (get_theme_mod('display_controls') == "0") ? "false" : "true";
	}else{
		$display_controls = "true";
	}
	if(get_theme_mod('enable_auto_transition')){
		$auto_transition = (get_theme_mod('enable_auto_transition') == "0") ? "false" : "true";
	}else{
		$auto_transition = "true";
	}
	if(get_theme_mod('transition_type')){
		$transition_type = get_theme_mod('transition_type');
	}else{
...
function eightstore_lite_homepage_slider_content(){
	$display_slider = (get_theme_mod('display_slider'))?get_theme_mod('display_slider','1'):"1";
	$display_captions = (get_theme_mod('display_captions'))?get_theme_mod('display_captions','1'):"1";
	if( $display_slider == "1") :
		?>
		...
		<div class="es-slider">
			...
			if($loop->have_posts()) : 
				...
				<div class="slides">
					...
					<?php 
					$display_captions = get_theme_mod('display_captions');
