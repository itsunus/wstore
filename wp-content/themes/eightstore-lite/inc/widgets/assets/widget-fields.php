...
function widgets_media_scripts($hook) {
    ...
    wp_enqueue_style( 'eightstore-lite-admin-control', get_template_directory_uri() . '/inc/css/admin-control.css' );
    wp_enqueue_script('eightstore-lite-admin-control', get_template_directory_uri() . '/inc/js/admin-control.js', array('jquery'));
