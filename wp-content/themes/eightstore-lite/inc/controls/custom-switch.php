...
if(class_exists( 'WP_Customize_control')):
	...
	function inc_custom_admin_style($hook) {
		...
		wp_enqueue_style( 'custom-control-admin-css', get_template_directory_uri() . '/inc/css/admin-control.css');
		wp_enqueue_script( 'custom-control-admin-js', get_template_directory_uri().'/inc/js/admin-control.js', array( 'jquery' ), '20150611', true );
	}
